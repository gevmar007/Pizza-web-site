...
import logoPng from '../../assets/img/image 1.png'
import './header.css'
...
function Header() {
  ...
  const pizzaCount= pizzaCart.reduce((acum, item)=>{
  ...
  return (
    <div className='Header'>
      ...
      <div className='homeLogo'>
        <Link to='/'className='homeLogoLink'>
        <img src={logoPng} alt="" />
        <div className='paren_title'>
          <h2>REACT PIZZA</h2>
      ...
      <div className='hom_cartbtn'>
        <Link to="Cart">
        {totalPrice} <div className='line'></div><span><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
